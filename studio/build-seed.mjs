...
const docs = [
  ...
  // ── /visit page singleton ─────────────────────────────────────────────────
  {
    ...
    heroSubcopy: "First time at a Celestial Church of Christ parish? Here's what to expect. Bring your questions; the doors are open.",
    whenEyebrow: 'When',
    whenHeading: 'Sundays at 10 AM.',
    whenSubcopy: 'Main worship runs from 10 in the morning to 2 in the afternoon. The parish keeps a full week of prayer and study around that anchor.',
    schedule: [
      { _key: 'sun', _type: 'serviceSlot', day: 'Sunday', detail: 'Worship · 10 AM – 2 PM', highlight: true },
      { _key: 'mon', _type: 'serviceSlot', day: 'Monday', detail: 'Bible Study · 8 PM', highlight: false },
      { _key: 'tue', _type: 'serviceSlot', day: 'Tuesday', detail: 'Prophesying Into Your Situation · 8 PM', highlight: false },
      { _key: 'wed', _type: 'serviceSlot', day: 'Wednesday', detail: 'Seeker Service · 9 AM', highlight: false },
      { _key: 'thu', _type: 'serviceSlot', day: 'Thursday', detail: 'Midnight Vigil · 12 AM', highlight: true },
      { _key: 'fri', _type: 'serviceSlot', day: 'Friday', detail: 'Power Day Service · 9:30 PM', highlight: false },
      { _key: 'sat', _type: 'serviceSlot', day: 'Saturday', detail: "Women's Fellowship · 5 PM", highlight: false },
    ],
    serviceEyebrow: 'What happens during service',
    serviceHeading: 'Divinely revealed,',
    serviceHeadingItalic: 'biblically grounded.',
    serviceIntro: "A Celestial Church of Christ service is unconventional in appearance and ancient in pattern. If you've never been to one, here's what you'll see and why we do it that way.",
    serviceElements: [
      { _key: 'shoes', _type: 'serviceElement', term: "You'll be asked to remove your shoes.", definition: 'This follows the biblical pattern (Exodus 3:5) of approaching holy ground. Sandals or socks are fine. There is a rack at the entrance.' },
      { _key: 'sutana', _type: 'serviceElement', term: 'White sutanas — encouraged but optional.', definition: "Members wear white robes called sutanas; visitors are not required to. The garments symbolize heavenly citizenship and the biblical attire of saints. If you come without one, you'll be just as welcome." },
      { _key: 'covering', _type: 'serviceElement', term: 'Women wear head coverings.', definition: "In keeping with 1 Corinthians 11, women cover their heads during service. If you don't have one, there are coverings at the door." },
      { _key: 'candles', _type: 'serviceElement', term: 'Seven candlesticks burn at the altar.', definition: "They represent the seven spirits of God described in Revelation. The altar itself represents God's throne." },
      { _key: 'incense', _type: 'serviceElement', term: 'Incense and water are part of prayer.', definition: "Incense is burned during prayer for sanctification — a representation of prayer rising and of God's presence. Water sprinkling serves as purification, paralleling Old Testament practice and New Testament redemption through Christ." },
      { _key: 'posture', _type: 'serviceElement', term: 'We kneel, bow, and lift our hands.', definition: "The parish emphasizes humble worship through posture — kneeling at moments of prayer, bowing at the altar, lifting hands during songs and intercession. Follow as you're able." },
    ],
    faqEyebrow: 'First time?',
    faqHeading: 'Questions you might have.',
    faqs: [
      { _key: 'wear', _type: 'visitFaq', q: 'What should I wear?', a: "Come as you are. Smart-casual is the norm for visitors — clean shirt, trousers or modest dress. You'll remove shoes at the entrance, and women cover their heads. The white sutana is for members and is not required of visitors." },
      { _key: 'children', _type: 'visitFaq', q: 'Can I bring my children?', a: "Yes. Children worship alongside the congregation; the parish runs a Youth Ministry that engages younger members through education, relationships, and Bible teaching. Stay with your kids during service — they're welcome at the altar." },
      { _key: 'first-time', _type: 'visitFaq', q: "I've never been to a Celestial Church before. Will I feel out of place?", a: "You'll be visibly new — that's fine. Several members will greet you. The Wednesday morning Seeker Service at 9 AM is specifically shaped around people exploring the parish for the first time; consider starting there if a full Sunday feels like a lot." },
      { _key: 'parking', _type: 'visitFaq', q: 'What about parking?', a: 'There is on-site parking at 11750 Cedar Avenue with street parking nearby for Sunday overflow. Arrive 10–15 minutes early on Sundays to find a spot before the 10 AM start.' },
      { _key: 'length', _type: 'visitFaq', q: 'How long is service?', a: "Sunday worship runs from 10 AM to about 2 PM, with fellowship and food after. You're welcome to stay for the whole arc or leave when you need to." },
      { _key: 'language', _type: 'visitFaq', q: 'Is the service in English?', a: "Yes. Songs are sung in both Yoruba (the Celestial Church's Nigerian roots) and English; readings, prayers, and the message are in English. The choir often translates as they go." },
    ],
  },
