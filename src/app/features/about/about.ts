...
interface AboutSection {
  ...
  heading: string;
  paragraphs: string[];
  /** Optional list — if provided, renders as a structured definition list rather than paragraphs. */
  list?: { term: string; definition: string }[];
  /** Optional scripture citation (e.g. "Isaiah 61") to render as a small ornament line. */
  scripture?: string;
}
        ...
        @for (section of sections; track section.id; let i = $index) {
          ...
          <section [id]="section.id" sanctumReveal class="scroll-mt-28">
            ...
            @if (section.list) {
              ...
              <div class="space-y-6 font-body text-base md:text-lg text-sanctum-ink/85 leading-[1.75]">
...
export class About {
  protected readonly anchors: AnchorItem[] = [
    { id: 'story', label: 'The Story' },
    { id: 'mission', label: 'Mission' },
    { id: 'shepherd', label: 'Shepherd' },
    { id: 'doctrine', label: 'Doctrine' },
    { id: 'mode-of-worship', label: 'Mode of Worship' },
    { id: 'ministries', label: 'Ministries' },
    { id: 'choir', label: 'The Choir' },
  ];
  ...
  protected readonly sections: AboutSection[] = [
    ...
    },
    {
      ...
      eyebrow: 'Mission',
      heading:
        'To win and nurture souls for the kingdom of God — and shine light into darkness.',
      scripture: 'Isaiah 61',
      paragraphs: [
      ...
      list: [
        {
          term: 'Luli — grace',
          definition:
            'The church\'s cornerstone principle is Luli, meaning grace. This reflects the covenant through Jesus Christ, emphasizing that salvation through the grace of God is central to the parish\'s teachings.',
        },
        {
          term: 'The Triune God',
          definition:
            'We affirm belief in a triune God: God the Father, Jesus Christ the Son, and the Holy Spirit.',
        },
        {
          term: 'Five ministries',
          definition:
            'Drawing from Ephesians, we recognize five essential ministry roles — apostles, prophets, evangelists, pastors, and teachers — as integral to complete church function.',
        },
        {
          term: 'Holy Spirit gifts',
          definition:
            'As a charismatic congregation, we believe the Holy Spirit\'s gifts remain active today, just as documented in biblical accounts. Members actively demonstrate these spiritual gifts in contemporary worship.',
        },
        {
          term: 'Prayer',
          definition:
            'The parish prioritizes prayer as transformative and effective. Regular prayer gatherings occur throughout the week, with believers encouraged to petition God through consistent intercession.',
        },
        {
          term: 'Holiness',
          definition:
            'God is holy and demands that those who worship him must also be holy, adhering to specific tenets established through Holy Spirit guidance.',
        },
      ],
      paragraphs: [],
    },
    {
      ...
      heading:
        'These garments symbolize heavenly citizenship and the biblical attire of saints.',
      paragraphs: [
      ...
      list: [
        {
          term: 'Attire',
          definition:
            'Members remove their shoes; women wear head coverings. White robes called sutanas are encouraged but optional. According to the church, these garments symbolize heavenly citizenship and the biblical attire of saints.',
        },
        {
          term: 'Altar and candlesticks',
          definition:
            'The altar represents God\'s throne and features seven lit candlesticks symbolizing the seven spirits of God, as described in Revelation.',
        },
        {
          term: 'Incense',
          definition:
            'Incense is used during prayer and worship for sanctification, representing both prayer and God\'s presence.',
        },
        {
          term: 'Water sprinkling',
          definition:
            'Water sprinkling serves as a purification tool, paralleling Old Testament blood sacrifices and New Testament redemption through Christ\'s blood.',
        },
        {
          term: 'Posture',
          definition:
            'The church emphasizes humble worship through kneeling, bowing, and lifting hands in prayer — supported by numerous biblical references throughout the Old and New Testaments.',
        },
      ],
    },
    {
      ...
      list: [
        {
          term: 'Youth Ministry',
          definition:
            'Biblical guidance to young church members, helping them navigate education, relationships, and social challenges through Christian doctrine and teachings.',
        },
        {
          term: 'Women Ministry',
          definition:
            'Counseling services, prayer meetings, and Bible studies every Saturday at 5 PM — women gathering to discuss relevant topics and concerns.',
        },
        {
          term: 'Outreach Ministry',
          definition:
            'Serving the poor and assisting those in need through fundraising and resource distribution, reflecting the compassion demonstrated by Jesus.',
        },
        {
          term: 'Evangelism Ministry',
          definition:
            'Based on the Great Commission — "go out into the world and make disciples" (Matthew 28:19). Community outreach, the church blog, the monthly biblical digest, and Bible classes every Monday at 8 PM.',
        },
      ],
    },
    {
