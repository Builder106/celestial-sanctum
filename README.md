...
- ✅ **Phase 7** — Per-route SEO + sitemap + robots + llms.txt + Church JSON-LD + legacy `.php` 308 redirects. Lighthouse: 100/100/100/100 on every page except `/watch` (Best Practices 77, blocked by Spotify embed's 3rd-party cookies). LCP 457 ms, CLS 0.00.
- ⏳ **Phase 8** — DNS cutover
