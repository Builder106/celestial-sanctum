...
- ✅ **Phase 7** — Per-route SEO + sitemap + robots + llms.txt + Church JSON-LD + legacy `.php` 308 redirects + Spotify click-to-load facade. **Lighthouse 100/100/100/100 on every public route.** LCP 457 ms, CLS 0.00.
- ⏳ **Phase 8** — DNS cutover
